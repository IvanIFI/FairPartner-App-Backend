...
public class UserTestFactory {
    ...
    public static UserEntity buildTestUser() {
        UserEntity userTest = new UserEntity(UserTestConstants.NAME_1, UserTestConstants.EMAIL_1, UserTestConstants.ENCODED_PASSWORD);
    ...
    public static List<UserEntity> buildListTestUsers() {
        UserEntity userTest1 = new UserEntity(UserTestConstants.NAME_1, UserTestConstants.EMAIL_1, UserTestConstants.ENCODED_PASSWORD);
        ...
        UserEntity userTest2 = new UserEntity(UserTestConstants.NAME_2, UserTestConstants.EMAIL_2, UserTestConstants.ENCODED_PASSWORD);
